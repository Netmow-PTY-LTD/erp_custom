...
import { useGetPurchaseReturnInvoiceByIdQuery } from "@/store/features/purchaseOrder/purchaseReturnApiService";
...
export default function PurchaseReturnInvoicePrintPreview() {
    ...
    const { data: purchaseInvoiceData } = useGetPurchaseReturnInvoiceByIdQuery(Number(invoiceId), {
        skip: !invoiceId,
    });
