                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500 space-y-0.5 mt-1">
                      ...
                      {supplier?.contact_person && <p className="flex items-center gap-1.5"><User className="w-3.5 h-3.5" /> {supplier?.contact_person}</p>}
                    </div>
                  </div>
                </div>
              </div>
            ...
            <Card className="shadow-sm border-border/60">
              <CardContent className="p-4 flex flex-col gap-1">
                ...
                <span className="text-sm font-semibold flex items-center gap-2">
                  <Hash className="w-4 h-4 opacity-50" /> {po?.po_number || '-'}
                </span>
              </CardContent>
            </Card>
            <Card className="shadow-sm border-border/60">
              <CardContent className="p-4 flex flex-col gap-1">
                ...
                <span className="text-sm font-semibold flex items-center gap-2">
                  <Calendar className="w-4 h-4 opacity-50" /> {invoice?.invoice_date.split("T")[0]}
                </span>
              </CardContent>
            </Card>
            <Card className="shadow-sm border-border/60">
              <CardContent className="p-4 flex flex-col gap-1">
                ...
                <span className="text-sm font-semibold text-red-600 flex items-center gap-2">
                  <Calendar className="w-4 h-4 opacity-50" /> {invoice?.due_date || '-'}
                </span>
              </CardContent>
            </Card>
            <Card className="shadow-sm border-border/60">
                    ...
                    po.items.map((item: any) => (
                      <tr key={item.id} className="hover:bg-muted/20 transition-colors">
                        ...
                        <td className="px-6 py-4 text-right font-medium">
                          {currency} {Number(item.unit_cost).toFixed(2)}
                        </td>
