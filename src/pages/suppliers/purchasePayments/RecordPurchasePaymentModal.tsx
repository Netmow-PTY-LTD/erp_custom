...
import { useAddPurchasePaymentMutation } from "@/store/features/purchaseOrder/purchaseOrderApiService";
            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    ...
                    <p className="text-sm text-muted-foreground">
                        Invoice #{invoice?.invoice_number} - {invoice?.purchase_order?.supplier?.name}
                    </p>
                </DialogHeader>
