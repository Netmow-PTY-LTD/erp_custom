                ...
                <div className="w-full mb-6 text-sm">
                    <table className="w-full border-collapse table-border">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div className="font-bold">Payment for Sales Order #{payment?.order?.order_number}</div>
                                    {payment?.invoice && (
                                        <div className="text-xs text-gray-600 mt-1">Invoice Reference: {payment.invoice.invoice_number}</div>
                                    )}
                                    <div className="text-xs text-gray-600 mt-1 text-uppercase">Payment Method: {payment?.payment_method?.replaceAll("_", " ")}</div>
