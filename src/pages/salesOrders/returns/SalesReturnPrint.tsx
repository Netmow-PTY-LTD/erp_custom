...
export default function SalesReturnPrint() {
    ...
    const { data: salesReturnData, isLoading: isReturnLoading } = useGetSalesReturnByIdQuery(Number(returnId), {
        skip: !returnId,
    });
    ...
    const mockInvoice = {
        ...
        due_date: salesReturn.return_date,
        total_amount: salesReturn.total_amount,
        discount_amount: salesReturn.discount_amount,
        tax_amount: salesReturn.tax_amount,
        grand_total: salesReturn.grand_total || salesReturn.total_payable_amount,
