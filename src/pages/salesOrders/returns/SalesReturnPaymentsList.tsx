...
import { useGetAllSalesReturnPaymentsQuery } from "@/store/features/salesOrder/salesReturnApiService";
import type { Payment } from "@/types/types";
import type { ColumnDef } from "@tanstack/react-table";
import { PlusCircle, Banknote, CheckCircle, Clock, XCircle, Eye } from "lucide-react";
...
export default function SalesReturnPaymentsList() {
    ...
    const columns: ColumnDef<Payment>[] = [
        ...
        },
        {
            ...
            cell: ({ row }) => (row.original as any).sales_return?.return_number || "-",
        },
        {
            id: "customer",
            header: "Customer",
        ...
        },
        {
            id: "invoice_number",
            header: "Invoice #",
            cell: ({ row }) => (row.original as any).invoice?.invoice_number || "-",
        },
        {
            accessorKey: "payment_date",
            header: "Refund Date",
            cell: ({ row }) => formatDateStandard(row.original.payment_date),
        },
        {
        ...
        },
        {
            ...
            header: "Actions",
            cell: ({ row }) => (
                <Link to={`/dashboard/sales/returns/payments/${row.original.id}`}>
    ...
    return (
        <div className="w-full space-y-6">
            <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <Link to="/dashboard/sales/returns/payments/create">
