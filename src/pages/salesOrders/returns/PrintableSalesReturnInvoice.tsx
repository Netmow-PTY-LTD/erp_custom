      ...
      `}</style>
            ...
            <div id="invoice" className="invoice-box print:border-0 print:p-0">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-2 pb-1 border-b border-gray-200 gap-2">
                    ...
                    <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800 text-center">Sales Return Invoice</h2>
                </div>
                <div className="flex flex-col sm:flex-row justify-between items-start mb-4 gap-4">
                    <div className="flex flex-col gap-2 text-left w-full sm:w-auto">
                        <div className="text-xs sm:text-[13px] text-left">
                            <h1 className="text-base sm:text-lg md:text-xl font-bold uppercase">{from?.company_name}</h1>
                            <p className="leading-tight max-w-full sm:max-w-[300px]">{from?.address}</p>
                            <p>T: {from?.phone}</p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 mb-4">
                    <div className="border border-gray-300">
                        <div className="bg-gray-100 px-3 py-1 font-bold text-xs sm:text-sm border-b border-gray-300 text-blue-700 text-left">Bill From</div>
                    ...
                    <div className="border border-gray-300">
                        <div className="bg-gray-100 px-3 py-1 font-bold text-xs sm:text-sm border-b border-gray-300 text-blue-700 text-left">Bill To (Customer)</div>
                        <div className="p-2 sm:p-3 text-xs sm:text-sm min-h-[80px] text-left">
