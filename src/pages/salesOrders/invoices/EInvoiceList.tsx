...
export default function EInvoiceList() {
    ...
    const columns: ColumnDef<any>[] = [
        ...
        },
        {
            ...
            header: "Date",
            cell: ({ row }) => row.original.invoice_date ? format(new Date(row.original.invoice_date), "dd MMM yyyy") : "-"
        },
        {
        ...
        },
        {
            ...
            header: "Amount",
            cell: ({ row }) => (
                <div className="font-medium tracking-tight">RM {Number(row.original.total_amount).toLocaleString(undefined, { minimumFractionDigits: 2 })}</div>
            )
        },
        {
