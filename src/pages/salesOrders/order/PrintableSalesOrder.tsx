...
export default function PrintableSalesOrder({ order, to, from }: Props) {
    ...
    // Total logic verification: if total_amount is gross, we might need adjustments
                    ...
                    <table className="w-full border-collapse">
                        ...
                        <tbody>
                            <tr className="text-center">
                                ...
                                <td className="border border-gray-300 p-1">{order?.delivery_date ? formatDate(String(order.delivery_date)) : "-"}</td>
