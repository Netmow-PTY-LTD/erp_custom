      ...
      <div className="flex flex-wrap items-center justify-between gap-5 mb-6 print:hidden">
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <Link to="/dashboard/sales/invoices">
            <Button className="flex items-center gap-2 bg-gradient-to-r from-amber-500 to-amber-400 hover:from-amber-600 hover:to-amber-500 text-white">
...

          {
            canRecordPayment && (
              <Link to="/dashboard/sales/payments">
                <Button className="flex items-center gap-2 bg-gradient-to-r from-cyan-600 to-cyan-500 hover:from-cyan-700 hover:to-cyan-600 text-white">
        ...
        <div id="invoice" className="hidden print:block mb-4">
          <div className="flex justify-between items-start mb-4">
            ...
            <div className="text-right flex flex-col items-end">
              ...
              <h2 className="font-bold text-gray-800 mb-1 uppercase details-text">Delivered Orders Report</h2>
