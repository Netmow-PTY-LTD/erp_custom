                ...
                cell: ({ row }) => {
                    ...
                    return (
                        <div className="font-medium text-slate-900 border-none shadow-none">
                            {staff?.first_name ? `${staff.first_name} ${staff.last_name}` : staff?.name || "N/A"}
                        </div>
                    );
                },
            },
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500 mt-0.5 font-medium italic">
                                {staffId === "all" ? "All staff members" : `${selectedStaff?.first_name} ${selectedStaff?.last_name}`} • {selectedDate ? format(selectedDate, "PPP") : "All dates"}
                            </p>
                        </div>
                    </div>
                </CardHeader>
