...
import { useGetBalanceSheetQuery } from "@/store/features/accounting/accoutntingApiService";
...
export default function BalanceSheet() {
    ...
    const totalAssets = reportData?.data?.total_assets || 0;
    const totalLiabilities = reportData?.data?.total_liabilities || 0;
    const totalEquity = reportData?.data?.total_equity || 0;
